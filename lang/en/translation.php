...
return [
  ...
  "Crypto" => "Crypto",
   ...
   "SMS-Connection"=> "Enable/Disable sending of the SMS with the contract to the customer", 
   "Sales-SMS-Connection" => "Enable/Disable Sales SMS",
   "CompanyName" => "CompanyName",
   "Add New Company"=>"Add New Company",
   "Total Sales"=> "Num. Sales",
   "view" => "View",
